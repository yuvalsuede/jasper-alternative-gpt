    ...
    inputs: [
      {
        ...
        placeholder:
          "The importance of time management. Tips for better time management. Benefits of effective time management.",
        type: "textarea",
      },
      {
        id: "cta",
        ...
        placeholder:
          "Share your time management tips with us in the comments below!",
        type: "text",
      },
      {
        id: "tone",
  ...
  },
  {
    ...
    inputs: [
      ...
      },
      {
        ...
        label: "Audience",
        placeholder:
          "Young professionals, Students, Budget-conscious individuals",
        type: "text",
      },
      {
        id: "tone",
...

  {
    ...
    inputs: [
      ...
      },
      {
        ...
        placeholder:
          "Eco-friendly products for a sustainable lifestyle, including reusable bags, water bottles, and home cleaning solutions.",
        type: "textarea",
      },
      {
        id: "audience",
        label: "Audience",
        placeholder:
          "Eco-conscious consumers, Sustainability advocates, Homeowners",
        type: "text",
      },
      {
        id: "tone",
    ...
    inputs: [
      {
        ...
        placeholder:
          "Innovative online marketplace connecting local service providers and customers.",
      },
      {
    ...
    inputs: [
      {
        ...
        label: "Plot",
        placeholder:
          "A magical kingdom faces a drought that threatens its existence. The king sends a brave knight on a quest to find a legendary water source.",
      },
      {
        id: "tone",
        type: "text",
  ...
  },
  {
    ...
    inputs: [
      ...
      },
      {
        ...
        placeholder:
          "InnovateTech is a cutting-edge technology firm that specializes in developing software solutions for businesses. Founded in 2018 and based in New York City, we focus on helping companies streamline their processes and improve customer engagement.",
      },
      {
        id: "tone",
        type: "text",
  ...
  },
  {
    ...
    inputs: [
      ...
      },
      {
        ...
        placeholder:
          "InnovateTech is a cutting-edge technology firm that specializes in developing software solutions for businesses.",
      },
      {
        id: "jobOverview",
        type: "textarea",
        label: "Job Overview",
        placeholder:
          "We are looking for a skilled Software Engineer to join our team and help us develop high-quality software solutions.",
      },
      {
        id: "responsibilities",
        type: "textarea",
        ...
        placeholder:
          "Design, develop, and maintain software solutions. Collaborate with cross-functional teams to deliver high-quality products.",
      },
      {
        id: "requirements",
        type: "textarea",
        label: "Requirements",
        placeholder:
          "Bachelor's degree in Computer Science or related field. Proficient in JavaScript, Python, or Java.",
      },
      {
        id: "benefits",
        type: "textarea",
        label: "Benefits",
        placeholder:
          "Competitive salary, flexible working hours, and a comprehensive benefits package.",
      },
      {
        id: "location",
        type: "text",
