...
const Sidebar: React.FC<Props> = ({ items, onShowPopup }) => {
  ...
  return (
    <>
      <button
        className="z-50 w-10 h-10 fixed top-4 left-4 md:hidden bg-white border border-gray-300 rounded-md p-2 focus:outline-none focus:ring-2 focus:ring-primary"
      ...
      <aside
        ...
        } md:translate-x-0 fixed top-0 left-0 h-full md:min-h-0 md:relative md:w-60 overflow-y-hidden`}
      >
        <div
