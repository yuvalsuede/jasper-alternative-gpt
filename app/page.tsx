  ...
  return (
    <>
      <h1 className="text-4xl font-bold mt-10 ml-10">
        ...
        <div>
          <a
            href="https://www.producthunt.com/posts/jema-ai?utm_source=badge-featured&utm_medium=badge&utm_souce=badge-jema&#0045;ai"
            target="_blank"
          >
            <img
      ...
      <h2 className="text-2xl font-light mt-5 ml-10">
        ...
        <strong className="text-blue-600">
          blog posts, marketing copy, SEO content
        </strong>{" "}
        and a lot more with ChatGPT.
      </h2>
